...
export async function addMember(organizationId: string, email: string, role: string = 'member') {
...
export async function hasRole(organizationId: string, requiredRole: string): Promise<boolean> {
  const user = await getUser();
